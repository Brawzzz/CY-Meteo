...
gnuplot << EOF
    ...
    set timefmt "%Y-%m-%dT%H:%M:%S"                        
    set format x "%Y/%m/%d"                                    
    plot "result1.csv" every 10 using 3:7 lt 5 lc 0 pt 27 w lp
EOF
        echo Done
    ;;
    -p2)
...
# set datafile separator "," 
# set palette rgb 33,13,10 
# splot "h_avl.csv" using 9:10:6 with line palette
# # # #titre / recadrer 
...
# set palette rgb 33,13,10                                                                                                 
# plot "t3.csv" u 3:5:4 w lp palette
# plot "t3.csv" every 1000 u 3:5:4 w lp palette  
# set xrange ["2010-01-01T01:00:00+01:00":"2022-09-30T20:00:00+02:00"]                                                     
# set yrange [-40:70]                                                                                                      
# plot "t3.csv" every 100 u 3:5:4 w l palette
